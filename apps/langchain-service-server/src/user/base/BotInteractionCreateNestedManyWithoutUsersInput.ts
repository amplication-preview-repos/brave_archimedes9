...
@InputType()
class BotInteractionCreateNestedManyWithoutUsersInput {
...
export { BotInteractionCreateNestedManyWithoutUsersInput as BotInteractionCreateNestedManyWithoutUsersInput };
